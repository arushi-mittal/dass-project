...
const AlertDialog = (props) => {
    ...
    if (actionType === 'report') {
        ...
        msgTitle = "Bookmark this record?"
        msgContent = "This will make this record disappear from this dashboard and will be saved in the Bookmarked records."
...
const SelectedRecord = (props) => {
    ...
    return (
        <div>
            <h3>Selected Record ID <b>{record.id}</b> - Take actions</h3>
            <Button
...
const RecordsDashboard = () => {
    ...
    // { "admin_email": "a1@mail.com","vehicle_type": "SUV", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "Sedan", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "Sedan", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "Sedan", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "Sedan", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "Hatchback", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad", ,
    // { "admin_email": "a1@mail.com","vehicle_type": "Hatchback", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad", ,
    // { "admin_email": "a1@mail.com","vehicle_type": "Hatchback", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad", ,
    // { "admin_email": "a1@mail.com","vehicle_type": "Hatchback", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "SUV", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "SUV", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "SUV", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "Truck", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "Bus", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // { "admin_email": "a1@mail.com","vehicle_type": "Bus", "plate_no": "CG 04 H 0001", "location": "Gachibowli, Hyderabad" },
    // ];
